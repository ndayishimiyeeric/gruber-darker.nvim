...
function M.get(options, palette)
    ...
    local highlights = {
        ...
        Title = { fg = palette.niagara, bold = true },
        ...
        StorageClass = { fg = palette.quartz, bold = true },
        Structure = { fg = palette.yellow, bold = true },
        ...
        SpecialComment = { fg = palette.wisteria, bold = true },

        Debug = { fg = palette.red },
        Error = { fg = palette.red },
        Todo = { fg = palette.yellow, bold = false },

...
function M.get(options, palette)
    ...
    local highlights = {
        ...
        DiffText = { fg = palette.yellow, bg = palette.gray },
        ...
        StatusLineNC = { fg = palette.quartz, bg = palette.bg2 },

        TabLine = { fg = palette.gray, bg = palette.bg2 },
        TabLineFill = { bg = palette.bg2 },
        ...
        NormalFloat = options.transparent and { fg = palette.fg, bg = nil } or { fg = palette.fg, bg = palette.bg2 },
        FloatBorder = { fg = palette.gray },

        Visual = { bg = palette.bg3 },
        VisualNOS = { bg = palette.bg3, fg = palette.gray },
        ...
        LspSignatureActiveParameter = { bg = palette.gray },
        LspCodeLens = { fg = palette.brown },
        LspCodeLensSeparator = { fg = palette.gray },
        LspInfoBorder = { fg = palette.gray },
